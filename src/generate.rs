...
pub fn generate_files() {
    ...
    if input == "y" || input == "yes" {
        ...
        let text_files = [
            ...
            ("static/forum_index.html", EXAMPLE_FORUM_INDEX, "forum_index.html"),
            ("static/forum_category.html", EXAMPLE_FORUM_CATEGORY, "forum_category.html"),
            ("static/forum_new_topic.html", EXAMPLE_FORUM_NEW_TOPIC, "forum_new_topic.html"),
            ("static/topic.html", EXAMPLE_FORUM_TOPIC, "topic.html"),
            ("static/forum_edit_post.html", EXAMPLE_FORUM_EDIT_POST, "forum_edit_post.html"),
            ...
            ("static/file-gate.html", FILE_GATE, "file-gate.html"),
